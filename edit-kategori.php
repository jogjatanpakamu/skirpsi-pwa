                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 form-group">
                                                <input type="text" id="bahan" class="form-control" name="bahan" value="<?= $data['bahan'] ?>" />
                                            </div>
                                            <div class="col-md-4">
                                                <label>JENIS SABLON</label>
                                            </div>
                                            <div class="col-md-8 form-group">
                                                <input type="text" id="jenis" class="form-control" name="jenis" value="<?= $data['jenis'] ?>" />
                                            </div>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-4">
                                                <input name="editkategori" type="submit" class="btn btn-primary btn-sm me-1 " value="UBAH">
                                                <a href="#" data-id="<?= $data['id'] ?>" class="btn btn-sm btn-danger btn-hapus-kategori"> Hapus</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
