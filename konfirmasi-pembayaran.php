                        ...
                        <div class="row">
                          ...
                          <div class="col-12 col-sm-6 col-lg-4">
                            <div class="form-group">
                              ...
                              <?= $riwayat['status'] != 1 ? '<span class="form-control badge bg-warning">Menunggu Di konfirmasi</span>' : '<span class="form-control badge bg-primary">Sudah Di konfirmasi</span>' ?>
                          ...
                          <div class="col-12">
                            <div class="form-group with-title mb-3">
                              <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"><?= $riwayat['catatan'] ?></textarea>
                              <label>Catatan</label>
                            </div>
                          </div>
                        </div>
                        <div class="col-12 col-sm-6 col-lg-12">
                          <a id="btn-wa" data-id="<?= $riwayat['pesid'] ?>" class="btn btn-success">Hubungi Penjual </a>
